...
from redis_om import EmbeddedJsonModel, Field, HashModel, JsonModel, Migrator
...
def test_json_model_get_uses_v1_field_fallback(key_prefix, redis):
...
@py_test_mark_sync
def test_hash_model_get_uses_v1_field_fallback(key_prefix, redis):
