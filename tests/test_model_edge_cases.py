...
def test_save_convert_value_datetime_naive():
    ...
    result = _save_convert_value(_FieldPlan(kind=_KIND_DATETIME, target_type=datetime.datetime), naive_dt)
...
def test_save_convert_value_datetime_aware():
    ...
    result = _save_convert_value(_FieldPlan(kind=_KIND_DATETIME, target_type=datetime.datetime), aware_dt)
    assert isinstance(result, float)
...
def test_save_convert_value_date():
    ...
    result = _save_convert_value(_FieldPlan(kind=_KIND_DATETIME, target_type=datetime.date), d)
    assert isinstance(result, float)
...
def test_save_convert_value_datetime_none():
    ...
    result = _save_convert_value(_FieldPlan(kind=_KIND_DATETIME, target_type=datetime.datetime), None)
    assert result is None


def test_save_convert_value_bytes():
    """bytes are base64-encoded to ascii string."""
    result = _save_convert_value(_FieldPlan(kind=_KIND_BYTES, target_type=bytes), b"hello")
...
def test_save_convert_value_bytes_non_bytes():
    ...
    result = _save_convert_value(_FieldPlan(kind=_KIND_BYTES, target_type=bytes), "not_bytes")
...
def test_save_convert_value_datetime_list():
    ...
    result = _save_convert_value(_FieldPlan(kind=_KIND_DATETIME_LIST, target_type=datetime.datetime), dt_list)
...
def test_save_convert_value_bytes_list():
    ...
    b_list = [b"a", b"b"]
    result = _save_convert_value(_FieldPlan(kind=_KIND_BYTES_LIST, target_type=bytes), b_list)
    assert isinstance(result, list)
...
def test_save_convert_value_kind_none_returns_value():
    ...
    result = _save_convert_value(_FieldPlan(kind=_KIND_NONE, target_type=None), "anything")
...
def test_load_convert_scalar_bytes_invalid_base64():
    ...
    result = _load_convert_scalar(_FieldPlan(kind=_KIND_BYTES, target_type=bytes), "not-valid!!!")
...
def test_load_convert_scalar_bytes_valid_base64():
    ...
    result = _load_convert_scalar(_FieldPlan(kind=_KIND_BYTES, target_type=bytes), encoded)
...
def test_load_convert_scalar_datetime_list():
    ...
    result = _load_convert_scalar(_FieldPlan(kind=_KIND_DATETIME_LIST, target_type=datetime.datetime), ts_list)
    assert isinstance(result, list)
...
def test_load_convert_scalar_bytes_list():
    ...
    result = _load_convert_scalar(_FieldPlan(kind=_KIND_BYTES_LIST, target_type=bytes), b64_list)
    assert isinstance(result, list)
