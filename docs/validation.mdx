---
title: Validation
description: Pydantic-backed validation for Redis OM models, including strict types and custom validators.
---
...
All of these constraint types work with Redis OM models. Read the [Pydantic documentation on constrained types](https://docs.pydantic.dev/latest/concepts/fields/) to learn more.
